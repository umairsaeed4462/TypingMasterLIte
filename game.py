words = ['grapes','Mango','Apple','gun','fan','door','tv','mobile','laptop','clasic','printed','yellow','python','go','done','welcome','Reads','pink','queen','You','that','before','cut','zoom']

def labelSlider():
    global count,sliderWords
    text = 'Welcome to typing Speed lite gamming0'
    if(count >= len(text)):
        count = 0
        sliderWords = ''
