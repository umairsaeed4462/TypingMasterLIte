...
keybord_Key_Pos = {
                    ...
                    "e" : "125,9,150,40",
                    "r" : "160,9,185,40", 
                    "t" : f"{280-80},{242-233},{305-80},{277-237}",
                    "y" : f"{315-80},{242-233},{340-80},{277-237}",
                    "u" : f"{355-80},{242-233},{380-80},{277-237}",
                    "i" : f"{390-80},{242-233},{415-80},{277-237}",
                    "o" : f"{430-80},{242-233},{455-80},{277-237}",
                    "p" : f"{465-80},{242-233},{493-80},{277-237}", 
                    "a" : f"{130-80},{287-233},{160-80},{320-237}", 
                    "s" : f"{170-80},{287-233},{197-80},{320-237}",
                    "d" : f"{210-80},{287-233},{234-80},{320-237}",
                    "f" : f"{245-80},{287-233},{271-80},{320-237}",
                    "g" : f"{285-80},{287-233},{308-80},{320-237}",
                    "h" : f"{320-80},{287-233},{345-80},{320-237}",
                    "j" : f"{360-80},{287-233},{382-80},{320-237}", 
                    "k" : f"{395-80},{287-233},{419-80},{320-237}", 
                    "l" : f"{435-80},{287-233},{459-80},{320-237}", 
                    ";" : f"{470-80},{287-233},{500-80},{320-237}",
                    "z" : f"{150-80},{330-233},{178-80},{360-237}",
                    "x" : f"{190-80},{330-233},{215-80},{362-237}", 
                    "c" : f"{225-80},{330-233},{252-80},{363-237}", 
                    "v" : f"{265-80},{330-233},{289-80},{363-237}",
                    "b" : f"{300-80},{330-233},{326-80},{363-237}",
                    "n" : f"{340-80},{330-233},{363-80},{363-237}", 
                    "m" : f"{375-80},{330-233},{403-80},{363-237}",
                    "," : f"{415-80},{330-233},{440-80},{363-237}",
                    "." : f"{450-80},{330-233},{477-80},{363-237}", 
                    "/" : f"{490-80},{330-233},{514-80},{363-237}",
                    "space" : f"{125},{142},{370},{170}",
};
# left_canvas.pack()
I = 0;
...
def keypressed(event):
    global yourporgress,key_count,total_space,I,curr_rect_pos_x,curr_rect_pos_y,xx,yy,text_pos,key_correct,key_wrong;
    char = event.keysym;
