...
btn_Y = 80;
btn_height_dif = 70;  
studying_btn = Button(main_box,justify="center",cursor=cursor_pointer,activebackground=bg_color,bg=bg_color,fg=acitve_main_fg_color,text="Studying",font=acitve_main_font,bd=0,relief=FLAT,command=select_studying);

# studying_btn.bind('<<Ctrl + c>>',run)
typingTest_btn = Button(main_box,justify="center",cursor=cursor_pointer,activebackground=bg_color,bg=main_bg_color,fg=main_bg_text_color,text="Typing Test",font=main_text_font,bd=0,relief=FLAT,command=select_typingtest);
# btn_Y += btn_height_dif;
games_btn = Button(main_box,justify="center",cursor=cursor_pointer,activebackground=bg_color,bg=main_bg_color,fg=main_bg_text_color,text="Gammes",font=main_text_font,bd=0,relief=FLAT,command=select_games);
# btn_Y += btn_height_dif;
setting_btn = Button(main_box,justify="center",cursor=cursor_pointer,activebackground=bg_color,bg=main_bg_color,fg=main_bg_text_color,text="Setting",font=main_text_font,bd=0,relief=FLAT,command=select_setting);
# btn_Y += btn_height_dif;
about_btn = Button(main_box,justify="center",cursor=cursor_pointer,activebackground=bg_color,bg=main_bg_color,fg=main_bg_text_color,text="About",font=main_text_font,bd=0,relief=FLAT,command=select_about);
...
def keylessons(file,allwords):
    ...
    def updatealldata():
        global key_exit_ftn, keys_pressed, final_time, initial_time, key_count, total_space, total_words, I, xx, yy, key_correct, key_wrong, yourporgress;
        global curr_rect_pos_x,curr_rect_pos_y,word,text_pos;
        key_exit_ftn = keys_pressed = final_time = initial_time = key_count = total_space = total_words = I = xx = yy = key_correct = key_wrong = yourporgress = 0;
        text_pos = 80;
        curr_rect_pos_x = 60;
        curr_rect_pos_y = 100;
...
#lesson 1 fuctions
def les1(event=None):
    lesson_1.config(bg="lightgreen",fg="white");
    lesson_2.config(bg=bg_color,fg="green");
    lesson_3.config(bg=bg_color,fg="green");
    lesson_1_frame.pack(anchor='w',pady=50,expand=1,fill='both');
    lesson_2_frame.pack_forget();
    lesson_3_frame.pack_forget();
def les2(event=None):
    lesson_2.config(bg="lightgreen",fg="white");
    lesson_1.config(bg=bg_color,fg="green");
    lesson_3.config(bg=bg_color,fg="green");
    lesson_1_frame.pack_forget();
    lesson_2_frame.pack(anchor='w',pady=50,expand=1,fill='both');
    lesson_3_frame.pack_forget();
def les3(event=None):
    lesson_3.config(bg="lightgreen",fg="white");
    lesson_2.config(bg=bg_color,fg="green");
    lesson_1.config(bg=bg_color,fg="green");
    lesson_1_frame.pack_forget();
    lesson_2_frame.pack_forget();
...
lesson_1 = Button(studying_lesson,text="1",cursor=cursor_pointer,bd=0,relief=FLAT,activebackground="lightgreen",activeforeground="white",padx=6,bg="lightgreen",fg="white",font=('Calibri (Body)',15,"bold"),command=les1);
lesson_1.place(x=0,y=0);
lesson_2 = Button(studying_lesson,text="2",cursor=cursor_pointer,bd=0,relief=FLAT,activebackground="white",activeforeground="black",padx=6,bg=bg_color,fg="green",font=('Calibri (Body)',15,"bold"),command=les2);
lesson_2.place(x=60,y=0);
lesson_3 = Button(studying_lesson,text="3",cursor=cursor_pointer,bd=0,relief=FLAT,activebackground="white",activeforeground="black",padx=6,bg=bg_color,fg="green",font=('Calibri (Body)',15,"bold"),command=les3);
lesson_3.place(x=120,y=0);
#--------------------- create lession 1 frame -------------------
lesson_1_frame = Frame(studying_lesson,bg=bg_color)
#lesson 1 title
Label(lesson_1_frame,text="Lesson 1: Focus on Home Key’s",bg=bg_color,fg=acitve_main_fg_color,font=('Calibri (Body)',16)).pack(anchor='nw')
#lesson 1 keys
lesson_1_keyDrill = Label(lesson_1_frame,cursor=cursor_pointer,text="Key Drill",fg=main_bg_color,bg=bg_color,font=('Cordia New',28,'bold','italic','underline'))
lesson_1_keyDrill.place(x=10,y=50)
lesson_1_worldDrill = Label(lesson_1_frame,cursor=cursor_pointer,text="World Drill",fg=main_bg_color,bg=bg_color,font=('Cordia New',28,'bold','italic','underline'))
lesson_1_worldDrill.place(x=10,y=110)
lesson_1_tipTypingDrill = Label(lesson_1_frame,cursor=cursor_pointer,text="Tip: Typing Drill",fg=main_bg_color,bg=bg_color,font=('Cordia New',28,'bold','italic','underline'))
lesson_1_tipTypingDrill.place(x=10,y=170)
lesson_1_paragraphDrill = Label(lesson_1_frame,cursor=cursor_pointer,text="Paragraph Drill",fg=main_bg_color,bg=bg_color,font=('Cordia New',28,'bold','italic','underline'))
lesson_1_paragraphDrill.place(x=10,y=230)

def common_part_of_lesson_key_drill(event=None):
    global yourporgress;
    yourporgress = 0;
    studying_Fram.pack_forget();
    studying_btn.place_forget();
    typingTest_btn.place_forget();
    games_btn.place_forget();
    setting_btn.place_forget();
    about_btn.place_forget();
    set_icone.place_forget();
###################### key drill fuction of lession 1 ##################
def lesson_1_key_Drill(event=None):
    print("lesson_1_key_Drill") 
    common_part_of_lesson_key_drill();
    file = open("key_files\lesson_1.txt");
    allwords = file.readlines()
    keylessons(file,allwords)
    file.close();
#binded lesson on keydrill with its fucions
lesson_1_keyDrill.bind('<Button-1>',lesson_1_key_Drill)
###################################################################3
lesson_1_frame.pack(anchor='w',pady=50,expand=1,fill='both');
...
#lesson 2 title
Label(lesson_2_frame,text="Lesson 2: Focus on Top Row Key’s",bg=bg_color,fg=acitve_main_fg_color,font=('Calibri (Body)',16)).pack(anchor='nw')
#lesson 2 keys
lesson_2_keyDrill = Label(lesson_2_frame,activeforeground="red",cursor=cursor_pointer,text="Key Drill",fg=main_bg_color,bg=bg_color,font=('Cordia New',28,'bold','italic','underline'))
lesson_2_keyDrill.place(x=10,y=50)
lesson_2_worldDrill = Label(lesson_2_frame,activeforeground="red",cursor=cursor_pointer,text="World Drill",fg=main_bg_color,bg=bg_color,font=('Cordia New',28,'bold','italic','underline'))
lesson_2_worldDrill.place(x=10,y=110)
lesson_2_tipTypingDrill = Label(lesson_2_frame,activeforeground="red",cursor=cursor_pointer,text="Tip: Typing Drill",fg=main_bg_color,bg=bg_color,font=('Cordia New',28,'bold','italic','underline'))
lesson_2_tipTypingDrill.place(x=10,y=170)
lesson_2_paragraphDrill = Label(lesson_2_frame,activeforeground="red",cursor=cursor_pointer,text="Paragraph Drill",fg=main_bg_color,bg=bg_color,font=('Cordia New',28,'bold','italic','underline'))
lesson_2_paragraphDrill.place(x=10,y=230)
# lesson_2_frame.pack(anchor='w',pady=50,expand=1,fill='both');
def lesson_2_key_Drill(event=None):
    print("lesson_2_key_Drill") 
    common_part_of_lesson_key_drill();
    ...
    file.close();
#binded lesson on keydrill with its fucions
lesson_2_keyDrill.bind('<Button-1>',lesson_2_key_Drill)
...
#lesson 3 title
Label(lesson_3_frame,text="Lesson 3: Focus on Buttom Row Key’s",bg=bg_color,fg=acitve_main_fg_color,font=('Calibri (Body)',16)).pack(anchor='nw')
#lesson 3 keys
lesson_3_keyDrill = Label(lesson_3_frame,cursor=cursor_pointer,text="Key Drill",fg=main_bg_color,bg=bg_color,font=('Cordia New',28,'bold','italic','underline'))
lesson_3_keyDrill.place(x=10,y=50)
lesson_3_worldDrill = Label(lesson_3_frame,cursor=cursor_pointer,text="World Drill",fg=main_bg_color,bg=bg_color,font=('Cordia New',28,'bold','italic','underline'))
lesson_3_worldDrill.place(x=10,y=110)
lesson_3_tipTypingDrill = Label(lesson_3_frame,cursor=cursor_pointer,text="Tip: Typing Drill",fg=main_bg_color,bg=bg_color,font=('Cordia New',28,'bold','italic','underline'))
lesson_3_tipTypingDrill.place(x=10,y=170)
lesson_3_paragraphDrill = Label(lesson_3_frame,cursor=cursor_pointer,text="Paragraph Drill",fg=main_bg_color,bg=bg_color,font=('Cordia New',28,'bold','italic','underline'))
lesson_3_paragraphDrill.place(x=10,y=230)

def lesson_3_key_Drill(event=None):
    print("lesson_3_key_Drill") 
    common_part_of_lesson_key_drill();
    file = open("key_files\lesson_3.txt");
    allwords = file.readlines()
    keylessons(file,allwords)
    file.close();
#binded lesson on keydrill with its fucions
lesson_3_keyDrill.bind('<Button-1>',lesson_3_key_Drill)
